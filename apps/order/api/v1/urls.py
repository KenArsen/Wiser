...
from apps.order.api.v1.apis import order_apis, my_bids_apis

app_name = "order"

router = DefaultRouter()
router.register(r"", order_apis.OrderView)
router.register(r"history", order_apis.OrderHistoryView, basename="orderhistory")
...
urlpatterns = [
    ...
    path("<int:pk>/delivery-time/", order_apis.OrderView.as_view({"get": "get_delivery_time"}), name="order-delivery-time"),
    path(
