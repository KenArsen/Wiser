    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emergency_phone',
                 models.CharField(blank=True, max_length=20, null=True, verbose_name='Emergency Phone')),
                ('second_driver', models.BooleanField(default=False, verbose_name='Second Driver (team)')),
                ('lisense_number',
                 models.CharField(blank=True, max_length=255, null=True, verbose_name='Lisense Number')),
                (
